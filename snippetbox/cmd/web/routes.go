...
import (
	...
	"snippetbox.xscotophilic.art/ui"
)
...
func (app *application) routes() http.Handler {
	...
	router.Handler(
		http.MethodGet,
		"/about",
		dynamic.ThenFunc(app.aboutView),
	)
	router.Handler(
		http.MethodGet,
		"/snippet/view/:id",
	...
	router.Handler(
		...
		protected.ThenFunc(app.passwordUpdateForm),
	)
	router.Handler(
		http.MethodPost,
		"/account/password/update",
		protected.ThenFunc(app.passwordUpdatePost),
	)

	router.Handler(
		http.MethodGet,
		"/snippet/create",
		protected.ThenFunc(app.snippetCreateForm),
	)
	router.Handler(
		http.MethodPost,
		"/snippet/create",
