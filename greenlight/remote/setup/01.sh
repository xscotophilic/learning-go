...
# before we have installed support for all locales. Do not change this setting!
export LC_ALL=en_US.UTF-8

# Set the timezone for the server.
# A full list of available timezones can be found by running
...
curl -L 'https://dl.cloudsmith.io/public/caddy/stable/gpg.key' | sudo gpg --dearmor -o /usr/share/keyrings/caddy-stable-archive-keyring.gpg
