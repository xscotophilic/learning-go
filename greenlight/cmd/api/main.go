...
import (
	...
	_ "github.com/lib/pq"
	"greenlight.xscotophilic.art/internal/data"
	"greenlight.xscotophilic.art/internal/jsonlog"
	"greenlight.xscotophilic.art/internal/mailer"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@my.domain>", "SMTP sender")
